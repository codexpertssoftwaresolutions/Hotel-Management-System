...
public class GymSectionDashBoard extends javax.swing.JFrame {
    ...
    public GymSectionDashBoard(ResultSet loggedUser) {
        ...
        drawer = Drawer.newDrawer(this)
                ...
                .addChild(new DrawerItem("Equipment").build())
                .addChild(new DrawerItem("Memberships").build())
                .addChild(new DrawerItem("GymPackage").build())
        ...
        gui.finance.Dashboard dashboard = new gui.finance.Dashboard();
    ...
    private void setActiveTab(int tab) { // tab -> clicked tab index
        ...
        if (tab == 0) {
            ...
            bottomPanel.add(equipment, BorderLayout.CENTER);
        } else if (tab == 2) {
            Memberships membership = new Memberships();
            bottomPanel.add(membership, BorderLayout.CENTER);
        } else if (tab == 3) {
            GymPackage gymPackage = new GymPackage();
            bottomPanel.add(gymPackage, BorderLayout.CENTER);
        }

...
public class Payment extends javax.swing.JPanel {
    ...
    public Payment(DrawerController drawer) {
        initComponents();
        setTableAction();
        loadPayment();
//        loadPaymentTypes();
    ...
    private void initComponents() {
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Image2.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Stock ID", "Qty", "Date", "Payment Method", "Total"
            }
        ) {
